            ...
            <div class="col-12 col-md-7">
                ...
                <div class="welcome-intro">
                    ...
                    <div class="button-group">
                        <a href="contact.php" class="btn btn-bordered-white">Start a Project with Us....</a>
            ...
            <div class="col-12 col-md-5">
                ...
                <div class="welcome-thumb-wrapper mt-5 mt-md-0">
                    <span class="welcome-thumb-1">
                         <img class="welcome-animation d-block ml-auto" src="assets/img/thumb_1.png" alt=""> 
                    </span>
...
<div class="container">
  <h1 class="text-center mt-5">GIF of Our Systems</h1>
  
  <div class="row">
    <!-- POS System -->
    <div class="col-md-4 gif-container">
      <h3>POS System</h3>
      <img src="assets/img/gif/pos.gif.gif" alt="POS System GIF">
    </div>
    
    <!-- Delivery System -->
    <div class="col-md-4 gif-container">
      <h3>Delivery System</h3>
      <img src="assets/img/gif/delivery-system.gif.gif" alt="Delivery System GIF">
    </div>
    
    <!-- Delivery Driver App -->
    <div class="col-md-4 gif-container">
      <h3>Delivery Driver App</h3>
      <img src="assets/img/gif/delivery-driver-app.gif.gif" alt="Delivery Driver App GIF">
    </div>
  </div>
</div>
