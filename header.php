...
?>
    <!-- Title  -->
    <title>Neetra - <?php print $site_title ?></title>
...
";
                    ...
                    <ul class="navbar-nav action">
                        <li class="nav-item ml-3">
                            <a href="dashboard/login.php" class="btn ml-lg-auto btn-bordered-white"><i class="fas fa-paper-plane contact-icon mr-md-2"></i>Login</a>
                        </li>
                    </ul>
                </div>
            </nav>
